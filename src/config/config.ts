...
export const RPC_URL = process.env.SOLANA_RPC
...
/* -------- Token config (update if you want other mints/amounts) -------- */
// Mints
export const BASE_MINT = new PublicKey(process.env.USDC_DEV_MINT!)
export const QUOTE_MINT = new PublicKey(process.env.TEST_DEV_MINT!)
